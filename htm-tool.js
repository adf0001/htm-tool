...
var globalVarRef="window[\'"+globalVarName+"\']";
...
var showPopup= function( el, modal, cb ){
	...
	if( !elClose ){
		elClose= prependHtml( elBody, "<span name='ht-popup-close' style='float:right;text-decoration:none;padding:0em 0.3em;' class='ht-cmd' onclick=\""+globalVarRef+".hidePopup(this);\" title='关闭'>x</span>" );
	}
